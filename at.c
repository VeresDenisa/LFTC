...
bool arithTypeTo(Type *t1,Type *t2,Type *dst){
	...
	switch(t1->tb){
		case TB_INT:
			switch(t2->tb){
				case TB_INT:dst->tb=TB_INT;return true;
				case TB_CHAR:dst->tb=TB_INT;return true;
				case TB_DOUBLE:dst->tb=TB_DOUBLE;return true;
				default:return false;
				}
		case TB_DOUBLE:
			switch(t2->tb){
				case TB_INT:dst->tb=TB_DOUBLE;return true;
				case TB_DOUBLE:dst->tb=TB_DOUBLE;return true;
				case TB_CHAR:dst->tb=TB_DOUBLE;return true;
				default:return false;
				}
		case TB_CHAR:
			switch(t2->tb){
				case TB_INT:dst->tb=t2->tb;return true;
				case TB_DOUBLE:dst->tb=t2->tb;return true;
				case TB_CHAR:dst->tb=t2->tb;return true;
				default:return false;
				}
		default:return false;
		}
